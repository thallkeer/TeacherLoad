...
namespace TeacherLoad.Core.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //        table.UniqueConstraint("AK_GroupStudies_ClassType", x => x.ClassType);
            //    });
            ...
            //        ID = table.Column<int>(nullable: false)
            //            .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
            //        IndividualClassType = table.Column<string>(nullable: false),
            //        VolumeByPerson = table.Column<int>(nullable: false)
            //    },
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_PersonalStudies", x => x.ID);
            //        table.UniqueConstraint("AK_PersonalStudies_IndividualClassType", x => x.IndividualClassType);
            //    });
            ...
            //        TeacherID = table.Column<int>(nullable: false),
            //        IndividualClassTypeID = table.Column<int>(nullable: false),
            //        IndividualStudiesID = table.Column<int>(nullable: true)
            //    },
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_PersonalLoads", x => x.ID);
            //        table.ForeignKey(
            //            name: "FK_PersonalLoads_PersonalStudies_IndividualStudiesID",
            //            column: x => x.IndividualStudiesID,
            ...
            //migrationBuilder.CreateIndex(
            //    name: "IX_PersonalLoads_IndividualStudiesID",
            //    table: "PersonalLoads",
            //    column: "IndividualStudiesID");
